...
Dota2.Dota2Client = function Dota2Client(steamClient, debug, debugMore) {
    ...
    */
    ...
    this._gcClientHelloTimeoutId = null;
    ...
    this._sendClientHello = function() {
        ...
        if (self._gcClientHelloCount > 10) {
            self.Logger.warn("ClientHello has taken longer than 50 seconds! Reporting timeout...")
...
Dota2.Dota2Client.prototype.launch = function() {
    ...
    this._gcClientHelloTimeoutId = setTimeout(this._sendClientHello, 1000);
};
/**
...
Dota2.Dota2Client.prototype.exit = function() {
    ...
    if (this._gcClientHelloTimeoutId) {
        clearInterval(this._gcClientHelloTimeoutId);
        this._gcClientHelloTimeoutId = null;
    }
    this._gcReady = false;
