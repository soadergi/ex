...
Dota2.Dota2Client.prototype.createPracticeLobby = function(options, callback) {
  ...
  const payload = new Dota2.schema.CMsgPracticeLobbyCreate({
    lobby_details: new Dota2.schema.CMsgPracticeLobbySetDetails(lobby_details),
    pass_key: finalOptions.pass_key,
  })

  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCPracticeLobbyCreate, payload, onPracticeLobbyResponse, callback)
}
...
Dota2.Dota2Client.prototype.configPracticeLobby = function(lobby_id, options, callback) {
  ...
  const payload = new Dota2.schema.CMsgPracticeLobbySetDetails(Dota2._parseOptions(options, Dota2._lobbyOptions))
  payload.lobby_id = lobby_id

  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCPracticeLobbySetDetails, payload, onPracticeLobbyResponse, callback)
}
...
Dota2.Dota2Client.prototype.requestPracticeLobbyList = function(callback) {
  ...
  const payload = new Dota2.schema.CMsgPracticeLobbyList({})
  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCPracticeLobbyList, payload, onPracticeLobbyListResponse, callback)
}
...
Dota2.Dota2Client.prototype.requestFriendPracticeLobbyList = function(callback) {
  ...
  const payload = new Dota2.schema.CMsgFriendPracticeLobbyListRequest({})
  this.sendToGC(
    Dota2.schema.EDOTAGCMsg.k_EMsgGCFriendPracticeLobbyListRequest,
    payload,
...
Dota2.Dota2Client.prototype.balancedShuffleLobby = function(callback) {
  ...
  const payload = new Dota2.schema.CMsgBalancedShuffleLobby({})
  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCBalancedShuffleLobby, payload, onPracticeLobbyResponse, callback)
}
...
Dota2.Dota2Client.prototype.flipLobbyTeams = function(callback) {
  ...
  const payload = new Dota2.schema.CMsgFlipLobbyTeams({})
  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCFlipLobbyTeams, payload, onPracticeLobbyResponse, callback)
}
...
Dota2.Dota2Client.prototype.inviteToLobby = function(steam_id) {
  ...
  const payload = new Dota2.schema.CMsgInviteToLobby({
    steam_id,
  })
...
Dota2.Dota2Client.prototype.practiceLobbyKick = function(account_id, callback) {
  ...
  const payload = new Dota2.schema.CMsgPracticeLobbyKick({
    account_id,
  })
  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCPracticeLobbyKick, payload, onPracticeLobbyResponse, callback)
}
...
Dota2.Dota2Client.prototype.practiceLobbyKickFromTeam = function(account_id, callback) {
  ...
  const payload = new Dota2.schema.CMsgPracticeLobbyKickFromTeam({
    account_id,
  })
  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCPracticeLobbyKickFromTeam, payload, onPracticeLobbyResponse, callback)
}
...
Dota2.Dota2Client.prototype.joinPracticeLobby = function(id, password, callback) {
  ...
  const payload = new Dota2.schema.CMsgPracticeLobbyJoin({
    lobby_id: id,
    pass_key: password,
  })
  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCPracticeLobbyJoin, payload, onPracticeLobbyJoinResponse, callback)
}
...
Dota2.Dota2Client.prototype.leavePracticeLobby = function(callback) {
  ...
  const payload = new Dota2.schema.CMsgPracticeLobbyLeave({})
  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCPracticeLobbyLeave, payload, onPracticeLobbyResponse, callback)
}
...
Dota2.Dota2Client.prototype.destroyLobby = function(callback) {
  ...
  this.Logger.debug('Sending match CMsgDOTADestroyLobby request')

  const payload = new Dota2.schema.CMsgDOTADestroyLobbyRequest({})
  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgDestroyLobbyRequest, payload, onDestroyLobbyResponse, callback)
}
...
Dota2.Dota2Client.prototype.abandonCurrentGame = function(callback) {
  ...
  const payload = new Dota2.schema.CMsgAbandonCurrentGame({})
  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCAbandonCurrentGame, payload, onPracticeLobbyResponse, callback)
}
...
Dota2.Dota2Client.prototype.launchPracticeLobby = function(callback) {
  ...
  const payload = new Dota2.schema.CMsgPracticeLobbyLaunch({})
  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCPracticeLobbyLaunch, payload, onPracticeLobbyResponse, callback)
}
...
Dota2.Dota2Client.prototype.joinPracticeLobbyTeam = function(slot, team, callback) {
  ...
  const payload = new Dota2.schema.CMsgPracticeLobbySetTeamSlot({
    team,
    slot,
  })
  this.sendToGC(Dota2.schema.EDOTAGCMsg.k_EMsgGCPracticeLobbySetTeamSlot, payload, onPracticeLobbyResponse, callback)
}
...
Dota2.Dota2Client.prototype.joinPracticeLobbyBroadcastChannel = function(channel, callback) {
  ...
  const payload = new Dota2.schema.CMsgPracticeLobbyJoinBroadcastChannel({
    channel,
  })
  this.sendToGC(
    Dota2.schema.EDOTAGCMsg.k_EMsgGCPracticeLobbyJoinBroadcastChannel,
    payload,
...
Dota2.Dota2Client.prototype.respondLobbyInvite = function(id, accept) {
  ...
  // todo: set client version here?
  const payload = new Dota2.schema.CMsgLobbyInviteResponse({
    lobby_id: id,
    accept,
  })
...
var onDestroyLobbyResponse = function onDestroyLobbyResponse(message, callback) {
  callback = callback || null
  const lobbyDestroyed = Dota2.schema.CMsgDOTADestroyLobbyResponse.decode(message)
...
var onPracticeLobbyJoinResponse = function onPracticeLobbyJoinResponse(message, callback) {
  callback = callback || null
  const practiceLobbyJoinResponse = Dota2.schema.CMsgPracticeLobbyJoinResponse.decode(message)
...
var onPracticeLobbyListResponse = function onPracticeLobbyListResponse(message, callback) {
  const practiceLobbyListResponse = Dota2.schema.CMsgPracticeLobbyListResponse.decode(message)
...
var onPracticeLobbyResponse = function onPracticeLobbyResponse(message, callback) {
  const practiceLobbyResponse = Dota2.schema.CMsgGenericResult.decode(message)
...
var onFriendPracticeLobbyListResponse = function onFriendPracticeLobbyListResponse(message, callback) {
  const practiceLobbyListResponse = Dota2.schema.CMsgFriendPracticeLobbyListResponse.decode(message)
...
const onInviteCreated = function onInviteCreated(message) {
  const inviteCreated = Dota2.schema.CMsgInvitationCreated.decode(message)
  const is_online = !inviteCreated.user_offline
