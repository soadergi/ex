...
import {
  createBannerByTypeSelector,
  isEventBannerTwitchStreamsAvailableSelector,
} from 'weplay-media/reduxs/banners/reducer'
...
const container = compose(
  connect(createStructuredSelector({
    ...
    banner: createBannerByTypeSelector(BANNERS_FORMATS.EVENT),
    isStreamAvailable: isEventBannerTwitchStreamsAvailableSelector,
  }), {
